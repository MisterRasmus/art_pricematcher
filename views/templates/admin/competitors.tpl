        ...
        <form method="post" action="{$form_action}" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <p class="help-block">
                        {l s='This name will be used to create the competitor class file.' mod='art_pricematcher'}</p>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    ...
                    <p class="help-block">{l s='URL to the competitor\'s website (optional).' mod='art_pricematcher'}
                    </p>
                </div>
            </div>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                        <i class="icon-cog"></i> {l s='Actions' mod='art_pricematcher'} <span
                                            class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="javascript:void(0);" class="js-edit-competitor"
                                                data-id="{$competitor.id_competitor}">
                                                <i class="icon-pencil"></i> {l s='Edit Settings' mod='art_pricematcher'}
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{$link->getAdminLink('AdminPriceMatcher')}&tab=dashboard&action=download&competitor={$competitor.name}">
                                                <i class="icon-download"></i> {l s='Download Prices' mod='art_pricematcher'}
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{$link->getAdminLink('AdminPriceMatcher')}&tab=dashboard&action=compare&competitor={$competitor.name}">
                                                <i class="icon-refresh"></i> {l s='Compare Prices' mod='art_pricematcher'}
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="{$link->getAdminLink('AdminPriceMatcher')}&tab=dashboard&action=update&competitor={$competitor.name}">
                                                <i class="icon-tag"></i> {l s='Update Prices' mod='art_pricematcher'}
                                            </a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a href="javascript:void(0);" class="js-toggle-competitor"
                                                data-id="{$competitor.id_competitor}"
                                                data-status="{if $competitor.active}0{else}1{/if}">
                                                {if $competitor.active}
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="js-delete-competitor text-danger"
                                                data-id="{$competitor.id_competitor}" data-name="{$competitor.name}">
                ...
                <form method="post" action="{$form_action}" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="competitor[{$competitor.id_competitor}][active]" value="1"
                                        {if $competitor.active}checked="checked" {/if} />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="competitor[{$competitor.id_competitor}][url]" class="form-control"
                                value="{$competitor.url|escape:'html':'UTF-8'}" />
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
                                                    name="competitor[{$competitor.id_competitor}][cron_download]" value="1"
                                                    {if isset($competitor.cron_download) && $competitor.cron_download}checked="checked"
                                                    {/if} />
                                                {l s='Enable automatic download for this competitor' mod='art_pricematcher'}
                                            </label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
                                                    name="competitor[{$competitor.id_competitor}][cron_compare]" value="1"
                                                    {if isset($competitor.cron_compare) && $competitor.cron_compare}checked="checked"
                                                    {/if} />
                                                {l s='Enable automatic price comparison for this competitor' mod='art_pricematcher'}
                                            </label>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
                                                    name="competitor[{$competitor.id_competitor}][cron_update]" value="1"
                                                    {if isset($competitor.cron_update) && $competitor.cron_update}checked="checked"
                                                    {/if} />
                                                {l s='Enable automatic price updates for this competitor' mod='art_pricematcher'}
                                            </label>
                                        </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="well">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"
                                                    ...
                                                    {if isset($competitor.override_discount_settings) && $competitor.override_discount_settings}checked="checked"
                                                    {/if} />
                                ...
                                <div class="competitor-specific-settings" id="competitor-settings-{$competitor.id_competitor}"
                                    {if !isset($competitor.override_discount_settings) || !$competitor.override_discount_settings}style="display: none;"
                                    {/if}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="competitor[{$competitor.id_competitor}][discount_strategy]"
                                                class="form-control">
                                                <option value="margin"
                                                    {if isset($competitor.discount_strategy) && $competitor.discount_strategy == 'margin'}selected="selected"
                                                    {/if}>
                                                    {l s='Maintain Minimum Margin' mod='art_pricematcher'}
                                                </option>
                                                <option value="discount"
                                                    {if isset($competitor.discount_strategy) && $competitor.discount_strategy == 'discount'}selected="selected"
                                                    {/if}>
                                                    {l s='Limit Maximum Discount' mod='art_pricematcher'}
                                                </option>
                                                <option value="both"
                                                    {if isset($competitor.discount_strategy) && $competitor.discount_strategy == 'both'}selected="selected"
                                                    {/if}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text"
                                                    name="competitor[{$competitor.id_competitor}][min_margin_percent]"
                                                    class="form-control"
                                                    value="{if isset($competitor.min_margin_percent)}{$competitor.min_margin_percent|escape:'html':'UTF-8'}{else}{$settings.global.min_margin_percent|escape:'html':'UTF-8'}{/if}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text"
                                                    name="competitor[{$competitor.id_competitor}][max_discount_percent]"
                                                    class="form-control"
                                                    value="{if isset($competitor.max_discount_percent)}{$competitor.max_discount_percent|escape:'html':'UTF-8'}{else}{$settings.global.max_discount_percent|escape:'html':'UTF-8'}{/if}" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text"
                                                    name="competitor[{$competitor.id_competitor}][price_underbid]"
                                                    class="form-control"
                                                    value="{if isset($competitor.price_underbid)}{$competitor.price_underbid|escape:'html':'UTF-8'}{else}{$settings.global.price_underbid|escape:'html':'UTF-8'}{/if}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text"
                                                    name="competitor[{$competitor.id_competitor}][min_price_threshold]"
                                                    class="form-control"
                                                    value="{if isset($competitor.min_price_threshold)}{$competitor.min_price_threshold|escape:'html':'UTF-8'}{else}{$settings.global.min_price_threshold|escape:'html':'UTF-8'}{/if}" />
                                                <span class="input-group-addon">Kr</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <input type="text"
                                                    name="competitor[{$competitor.id_competitor}][discount_validity_days]"
                                                    class="form-control"
                                                    value="{if isset($competitor.discount_validity_days)}{$competitor.discount_validity_days|escape:'html':'UTF-8'}{else}{$settings.global.discount_validity_days|escape:'html':'UTF-8'}{/if}" />
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox"
                                                        ...
                                                        value="1"
                                                        {if isset($competitor.clean_expired_discounts) && $competitor.clean_expired_discounts}checked="checked"
                                                        {/if} />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger">
                    {l s='This will permanently remove the competitor and all related price matching settings.' mod='art_pricematcher'}
                </p>
                <p id="delete-competitor-name"></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default"
                    data-dismiss="modal">{l s='Cancel' mod='art_pricematcher'}</button>
